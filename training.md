...
#### Additional Resources (Latent Profile Analysis; LPA): *NOTE: For the LPA diabetes example (from slides) the final model chosen is discussed on page 595 (Masyn, 2013).*
